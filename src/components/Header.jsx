    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold"> CityDelivery</p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <Link to={"/aboutUs"}><li className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">
              About Us
            </li></Link>
          </motion.ul>
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "bejaouikhouloud98@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
